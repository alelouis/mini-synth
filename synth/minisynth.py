...
class Minisynth:
    def __init__(self):
        ...
        self.filter_env_offset = Mixer(
            inputs=[self.filter_offset, self.envelope_filter]
        )
        self.filter_env_ampl = Amplifier(
            value=self.filter_env_offset, gain=self.filter_env_amount
        )
